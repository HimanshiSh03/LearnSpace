...
import { Github, Linkedin, Mail, User, Code, BookOpen, Users } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="text-center md:text-left">
              <h2 className="text-2xl font-bold text-gray-800 mb-2">LearnSpace Project</h2>
              <p className="text-gray-600 mb-4">
                LearnSpace is an open-source educational platform designed to help students and professionals organize their learning journey. 
                It combines productivity tools with educational resources to create a comprehensive learning environment.
              </p>
              
              <div className="flex flex-wrap gap-4 justify-center md:justify-start mt-6">
                <div className="flex items-center bg-indigo-50 px-4 py-2 rounded-lg">
                  <Code className="text-indigo-600 mr-2" />
                  <span className="text-indigo-700 font-medium">Open Source</span>
                </div>
                <div className="flex items-center bg-green-50 px-4 py-2 rounded-lg">
                  <BookOpen className="text-green-600 mr-2" />
                  <span className="text-green-700 font-medium">Educational</span>
                </div>
            ...
            {teamMembers.map((member, index) => (
              <div key={index} className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                ...
                <div className="flex gap-4">
                  <a href={member.github} className="text-gray-500 hover:text-indigo-600">
                    <Github className="w-5 h-5" />
                  </a>
                  <a href={member.linkedin} className="text-gray-500 hover:text-indigo-600">
                    <Linkedin className="w-5 h-5" />
                  </a>
                  <a href={member.email} className="text-gray-500 hover:text-indigo-600">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">Project Vision</h2>
          <p className="text-gray-600 mb-4">
            Our vision is to create a platform that makes learning more accessible, organized, and collaborative. 
            We believe that everyone deserves quality educational tools regardless of their background or resources.
          </p>
          
          <h3 className="text-xl font-bold text-gray-800 mb-3">Contribute to LearnSpace</h3>
          <p className="text-gray-600 mb-4">
            LearnSpace is an open-source project, and we welcome contributions from developers, designers, educators, 
            and anyone passionate about education. Check out our GitHub repository to get started!
          </p>
