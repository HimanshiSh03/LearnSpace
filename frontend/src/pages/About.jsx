...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-300">
      {/* Navbar */}
      <nav className="sticky top-0 z-50 backdrop-blur-md bg-white/80 dark:bg-gray-900/80 border-b border-indigo-100 dark:border-gray-700 transition-colors duration-300">
        ...
        >
          {features.map((item, i) => (
            <motion.div
              ...
              className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl border border-white/40 dark:border-gray-700 rounded-2xl shadow-xl p-8 hover:shadow-2xl hover:border-indigo-200 dark:hover:border-indigo-500 transition-all"
            >
      ...
      <section className="container mx-auto px-6 py-16">
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-3xl shadow-xl border border-white/50 dark:border-gray-700/50 p-8 md:p-12 mb-8 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {teamMembers.map((member, index) => (
              <motion.div
                ...
                className="
                  group relative
                  border border-gray-100 dark:border-gray-700 rounded-2xl p-8
                  bg-gradient-to-b from-white to-gray-50/50 dark:from-gray-800 dark:to-gray-900/50
                ...
                <div className="flex items-center gap-5 mb-6">
                  <div
                    className="
                      ...
                      ring-4 ring-indigo-50 dark:ring-indigo-900/30
                      group-hover:ring-indigo-100 dark:group-hover:ring-indigo-800 group-hover:bg-indigo-600 group-hover:text-white
                      transition-all duration-300
                    "
                  >
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white group-hover:text-indigo-700 dark:group-hover:text-indigo-400 transition-colors">
                      {member.name}
                    </h3>
                    ...
                    {member.skills.map((skill, skillIndex) => (
                      <span
                        ...
                        className="
                          ...
                          hover:bg-indigo-100 dark:hover:bg-indigo-800 hover:scale-105
