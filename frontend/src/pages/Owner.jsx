...
import { Github, Linkedin, Mail, HomeIcon } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="md:flex">
            <div className="md:flex-shrink-0 md:w-1/3 bg-indigo-600 flex items-center justify-center p-8">
              <div className="text-center">
                ...
                <p className="text-indigo-200 mt-2">Learning & Productivity Hub</p>
              </div>
            </div>
            ...
            <div className="p-8 md:w-2/3">
              <div className="flex items-center mb-6">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">Open Source Learning Platform</p>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 pt-6">
                <h4 className="font-bold text-gray-800 mb-4">Connect with the Community</h4>
          ...
          <div className="bg-gray-50 p-8 border-t border-gray-200">
            <h3 className="text-xl font-bold text-gray-800 mb-4">Contribution Guidelines</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white p-4 rounded-lg shadow">
                ...
                <p className="text-gray-600 text-sm">Fork the repository and clone it locally to start contributing.</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow">
                <h4 className="font-bold text-gray-800 mb-2">2. Create Branch</h4>
                <p className="text-gray-600 text-sm">Create a new branch for your feature or bug fix.</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow">
                <h4 className="font-bold text-gray-800 mb-2">3. Submit PR</h4>
                <p className="text-gray-600 text-sm">Push your changes and submit a pull request for review.</p>
              </div>
            </div>
            <div className="mt-6">
              <Link 
